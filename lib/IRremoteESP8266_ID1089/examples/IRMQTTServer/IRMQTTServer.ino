...
#if USE_STATIC_IP
const IPAddress kIPAddress = IPAddress(192, 168, 3, 78);
const IPAddress kGateway = IPAddress(192, 168, 3, 253);
const IPAddress kSubnetMask = IPAddress(255, 255, 255, 0);
#endif  // USE_STATIC_IP

#if MQTT_ENABLE
// Address of your MQTT server.
#define MQTT_SERVER "211.180.34.58"  // <=- CHANGE_ME
...
const char* kMqttUsername = "hyunwoki ";  // <=- CHANGE_ME (optional)
const char* kMqttPassword = "a2520012";  // <=- CHANGE_ME (optional)
